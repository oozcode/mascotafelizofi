...
urlpatterns = [
    ...
    path('ficha/editar/<int:ficha_id>/', views.editar_ficha, name='editar_ficha'),
    path('reserva/aceptar/<int:reserva_id>/', views.aceptar_reserva, name='aceptar_reserva'),
    path('qr-veterinario-page/', views.qr_veterinario_page, name='qr_veterinario_page'),
    path('qr-veterinario/', views.qr_veterinario, name='qr_veterinario'),
]